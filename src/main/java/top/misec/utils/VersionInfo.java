...
public class VersionInfo {
    ...
    private static String projectRepo = "https://github.com/Whuihuan/bili";
    ...
    public static void printVersionInfo() {
        initInfo();
        JsonObject jsonObject = HttpUtils.doGet("https://api.github.com/repos/Whuihuan/bili/releases/latest");
        log.info("-----版本信息-----");
